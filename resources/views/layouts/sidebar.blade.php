<nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      {{-- <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Élèves</a></li>
            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Enseignant(e)s</a></li>
            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Classes</a></li>
            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Matieres</a></li>
          </ul>
        </div>
      </li> --}}
    ...
    <li class="nav-item {{ request()->is('eleves*') ? 'active' : '' }}">
      ...
      <li li class="nav-item">
        <a class="nav-link" href="{{ url('/enseignants') }}">
          <i class="mdi mdi-account"></i>
          <span class="menu-title">Enseignant(e)s</span>
        </a>
      </li>
      <li li class="nav-item">
      ...
      {{--<li class="nav-item">
        ...
        <div class="collapse" id="form-elements">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Enseignant(e)s</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
